...
* Checkout the rails-graphql-blog git tree from Github

          $ git clone https://github.com/alex-jin45/rails-graphql-blog.git
          $ cd rails-graphql-blog
          rails-graphql-blog$

* Run Bundler to install/bundle gems needed by the project:

          rails-graphql-blog$ bundle

* Create the database:

          rails-graphql-blog$ rails db:migrate

* Load sample records:

          rails-graphql-blog$ rails db:seed

* Run the Rails server in development mode

          rails-graphql-blog$ rails server

* Run Yarn to install javascript package in other terminal:

          rails-graphql-blog$ cd client
          rails-graphql-blog/client$ yarn

* Start client in development mode. You should be able to go to `http://localhost:8080` :

            rails-graphql-blog/client$ yarn start
